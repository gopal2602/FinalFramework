...
public class Login2BaseClass extends CucumberTestRunner {
    /***********************************
    ...
    public static boolean loginToApplication(WebDriver oBrowser, String userName, String password){
        String strText = null;
        try{
            Assert.assertTrue(AppIndependentMethods.setObject(oBrowser, LoginPage.obj_UserName_Edit, userName));
            Assert.assertTrue(AppIndependentMethods.setObject(oBrowser, LoginPage.obj_Password_Edit, password));
